...
class thd_backup_transaction:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'transaction_id', None, None, ), # 1
    (2, TType.STRING, 'state', None, None, ), # 2
    (3, TType.STRING, 'user_name', None, None, ), # 3
    (4, TType.STRING, 'image_id', None, None, ), # 4
    (5, TType.STRING, 'instance_id', None, None, ), # 5
    (6, TType.STRING, 'machine_name', None, None, ), # 6
    (7, TType.STRING, 'node_ip', None, None, ), # 7
    (8, TType.I64, 'progress', None, None, ), # 8
  )

  def __init__(self, transaction_id=None, state=None, user_name=None, image_id=None, instance_id=None, machine_name=None, node_ip=None, progress=None,):
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('thd_backup_transaction')
    if self.transaction_id is not None:
      oprot.writeFieldBegin('transaction_id', TType.STRING, 1)
    ...
    if self.instance_id is not None:
      oprot.writeFieldBegin('instance_id', TType.STRING, 5)
      oprot.writeString(self.instance_id)
      oprot.writeFieldEnd()
    if self.machine_name is not None:
      oprot.writeFieldBegin('machine_name', TType.STRING, 6)
    ...
    if self.progress is not None:
      oprot.writeFieldBegin('progress', TType.I64, 8)
...
class thd_SubmitImageInfo:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'submitID', None, None, ), # 1
    (2, TType.STRUCT, 'newImage', (thd_ImageInfo, thd_ImageInfo.thrift_spec), None, ), # 2
    (3, TType.STRING, 'baseImageID', None, None, ), # 3
    (4, TType.I32, 'state', None, None, ), # 4
    (5, TType.I64, 'progress', None, None, ), # 5
    (6, TType.I64, 'imageSize', None, None, ), # 6
    (7, TType.I64, 'uploadProgress', None, None, ), # 7
    (8, TType.I64, 'uploadSpeed', None, None, ), # 8
    (9, TType.STRING, 'remainingTime', None, None, ), # 9
  )

  def __init__(self, submitID=None, newImage=None, baseImageID=None, state=None, progress=None, imageSize=None, uploadProgress=None, uploadSpeed=None, remainingTime=None,):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.submitID = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRUCT:
          self.newImage = thd_ImageInfo()
          self.newImage.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRING:
          self.baseImageID = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.I32:
        ...
        if ftype == TType.I64:
          self.uploadProgress = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 8:
        if ftype == TType.I64:
          self.uploadSpeed = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.STRING:
          self.remainingTime = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('thd_SubmitImageInfo')
    if self.submitID is not None:
      oprot.writeFieldBegin('submitID', TType.STRING, 1)
      oprot.writeString(self.submitID)
      oprot.writeFieldEnd()
    if self.newImage is not None:
      oprot.writeFieldBegin('newImage', TType.STRUCT, 2)
      self.newImage.write(oprot)
      oprot.writeFieldEnd()
    if self.baseImageID is not None:
      oprot.writeFieldBegin('baseImageID', TType.STRING, 3)
      oprot.writeString(self.baseImageID)
      oprot.writeFieldEnd()
    if self.state is not None:
      oprot.writeFieldBegin('state', TType.I32, 4)
      oprot.writeI32(self.state)
      oprot.writeFieldEnd()
    if self.progress is not None:
      oprot.writeFieldBegin('progress', TType.I64, 5)
      oprot.writeI64(self.progress)
      oprot.writeFieldEnd()
    if self.imageSize is not None:
      oprot.writeFieldBegin('imageSize', TType.I64, 6)
      oprot.writeI64(self.imageSize)
      oprot.writeFieldEnd()
    if self.uploadProgress is not None:
      oprot.writeFieldBegin('uploadProgress', TType.I64, 7)
      oprot.writeI64(self.uploadProgress)
      oprot.writeFieldEnd()
    if self.uploadSpeed is not None:
      oprot.writeFieldBegin('uploadSpeed', TType.I64, 8)
      oprot.writeI64(self.uploadSpeed)
      oprot.writeFieldEnd()
    if self.remainingTime is not None:
      oprot.writeFieldBegin('remainingTime', TType.STRING, 9)
      oprot.writeString(self.remainingTime)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class thd_Transaction:
  ...
  thrift_spec = (
    ...
    (8, TType.STRING, 'submitTime', None, None, ), # 8
    (9, TType.I32, 'submitState', None, None, ), # 9
    (10, TType.I64, 'submitProgress', None, None, ), # 10
    (11, TType.I64, 'imageSize', None, None, ), # 11
    (12, TType.I64, 'uploadProgress', None, None, ), # 12
    (13, TType.I64, 'uploadSpeed', None, None, ), # 13
    (14, TType.STRING, 'user', None, None, ), # 14
    (15, TType.STRUCT, 'newImageInfo', (thd_ImageInfo, thd_ImageInfo.thrift_spec), None, ), # 15
    (16, TType.STRING, 'sumbitEstimatedTime', None, None, ), # 16
    (17, TType.STRING, 'modifyTime', None, None, ), # 17
    (18, TType.I64, 'vmcpu', None, None, ), # 18
    (19, TType.I64, 'vmmemory', None, None, ), # 19
    (20, TType.I64, 'vmdisk', None, None, ), # 20
    (21, TType.STRING, 'createMode', None, None, ), # 21
    (22, TType.STRING, 'platform', None, None, ), # 22
    (23, TType.STRING, 'bootFrom', None, None, ), # 23
  )

  def __init__(self, transactionID=None, imageID=None, state=None, instanceID=None, instancePort=None, instancePassword=None, downloadProgress=None, submitTime=None, submitState=None, submitProgress=None, imageSize=None, uploadProgress=None, uploadSpeed=None, user=None, newImageInfo=None, sumbitEstimatedTime=None, modifyTime=None, vmcpu=None, vmmemory=None, vmdisk=None, createMode=None, platform=None, bootFrom=None,):
    ...
    self.sumbitEstimatedTime = sumbitEstimatedTime
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.submitTime = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.I32:
          self.submitState = iprot.readI32();
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.I64:
          self.submitProgress = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.I64:
        ...
        if ftype == TType.STRING:
          self.sumbitEstimatedTime = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 17:
        if ftype == TType.STRING:
        ...
        if ftype == TType.I64:
          self.vmcpu = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 19:
        if ftype == TType.I64:
          self.vmmemory = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 20:
        if ftype == TType.I64:
          self.vmdisk = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 21:
        if ftype == TType.STRING:
          self.createMode = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 22:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('thd_Transaction')
    ...
    if self.submitTime is not None:
      oprot.writeFieldBegin('submitTime', TType.STRING, 8)
      oprot.writeString(self.submitTime)
      oprot.writeFieldEnd()
    if self.submitState is not None:
      oprot.writeFieldBegin('submitState', TType.I32, 9)
      oprot.writeI32(self.submitState)
      oprot.writeFieldEnd()
    if self.submitProgress is not None:
      oprot.writeFieldBegin('submitProgress', TType.I64, 10)
      oprot.writeI64(self.submitProgress)
      oprot.writeFieldEnd()
    if self.imageSize is not None:
      ...
      oprot.writeFieldEnd()
    if self.uploadProgress is not None:
      oprot.writeFieldBegin('uploadProgress', TType.I64, 12)
      oprot.writeI64(self.uploadProgress)
      oprot.writeFieldEnd()
    if self.uploadSpeed is not None:
      oprot.writeFieldBegin('uploadSpeed', TType.I64, 13)
      oprot.writeI64(self.uploadSpeed)
      oprot.writeFieldEnd()
    if self.user is not None:
    ...
    if self.newImageInfo is not None:
      oprot.writeFieldBegin('newImageInfo', TType.STRUCT, 15)
      self.newImageInfo.write(oprot)
      oprot.writeFieldEnd()
    if self.sumbitEstimatedTime is not None:
      oprot.writeFieldBegin('sumbitEstimatedTime', TType.STRING, 16)
      oprot.writeString(self.sumbitEstimatedTime)
      oprot.writeFieldEnd()
    if self.modifyTime is not None:
      oprot.writeFieldBegin('modifyTime', TType.STRING, 17)
      oprot.writeString(self.modifyTime)
      oprot.writeFieldEnd()
    if self.vmcpu is not None:
      oprot.writeFieldBegin('vmcpu', TType.I64, 18)
      oprot.writeI64(self.vmcpu)
      oprot.writeFieldEnd()
    if self.vmmemory is not None:
      oprot.writeFieldBegin('vmmemory', TType.I64, 19)
      oprot.writeI64(self.vmmemory)
      oprot.writeFieldEnd()
    if self.vmdisk is not None:
      oprot.writeFieldBegin('vmdisk', TType.I64, 20)
      oprot.writeI64(self.vmdisk)
      oprot.writeFieldEnd()
    if self.createMode is not None:
      oprot.writeFieldBegin('createMode', TType.STRING, 21)
      oprot.writeString(self.createMode)
      oprot.writeFieldEnd()
    if self.platform is not None:
      oprot.writeFieldBegin('platform', TType.STRING, 22)
      oprot.writeString(self.platform)
      oprot.writeFieldEnd()
    if self.bootFrom is not None:
      oprot.writeFieldBegin('bootFrom', TType.STRING, 23)
